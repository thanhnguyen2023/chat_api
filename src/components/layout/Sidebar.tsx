...
const Sidebar = ({ isLocationChat }: SideBarProps) => {
  ...
  const svgIconHome: Array<JSX.Element> = [
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.6901 2.27629C12.3038 1.9079 11.6962 1.9079 11.3099 2.27629L2.30989 10.8585C2.11199 11.0472 2 11.3087 2 11.5822V21C2 21.5523 2.44772 22 3 22H10V17C10 15.8954 10.8954 15 12 15C13.1046 15 14 15.8954 14 17V22H21C21.5523 22 22 21.5523 22 21V11.5822C22 11.3087 21.888 11.0472 21.6901 10.8585L12.6901 2.27629ZM16 20H20V12.0104L12 4.38178L4 12.0104V20H8V17C8 14.7909 9.79086 13 12 13C14.2091 13 16 14.7909 16 17V20Z"
        fill="#0C1014"
      />
    </svg>,
    <svg
  ...
  const svgIconSearch: Array<JSX.Element> = [
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.356 17.4773C13.9794 18.4371 12.3054 19 10.5 19C5.80558 19 2 15.1944 2 10.5C2 5.80558 5.80558 2 10.5 2C15.1944 2 19 5.80558 19 10.5C19 12.3054 18.4371 13.9794 17.4773 15.356L22.0104 19.8891C22.5962 20.4749 22.5962 21.4246 22.0104 22.0104C21.4246 22.5962 20.4749 22.5962 19.8891 22.0104L15.356 17.4773ZM16 10.5C16 13.5376 13.5376 16 10.5 16C7.46243 16 5 13.5376 5 10.5C5 7.46243 7.46243 5 10.5 5C13.5376 5 16 7.46243 16 10.5Z"
        fill="#0C1014"
      />
    </svg>,
  ];
  ...
  const svgIconProfile: Array<JSX.Element> = [
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1ZM8 10C8 7.79086 9.79086 6 12 6C14.2091 6 16 7.79086 16 10C16 12.2091 14.2091 14 12 14C9.79086 14 8 12.2091 8 10ZM18 18.9251C17.7921 17.2767 16.3412 16 14.5824 16H9.41761C7.65876 16 6.20792 17.2767 6 18.9251C7.63339 20.2218 9.72282 21 12 21C14.2772 21 16.3666 20.2218 18 18.9251Z"
        fill="#0C1014"
      />
    </svg>,
  ];
  ...
  const navItems = [
    ...
    {
      icon: iconNavItems.Notification,
      label: "Thông báo",
      path: "/notifications",
    },
    {
      icon: iconNavItems.Profile,
      label: "Trang cá nhân",
  ...
  return (
    <aside className={ `${isLocationChat ? "" : "flex-1"} hidden md:flex  flex-col border-r border-border h-screen p-4 sticky top-0 left-0 bg-background`}>
      <div className="py-6 px-2">
        <Link to="/feed" className="text-2xl font-bold flex items-center gap-2">
          <span className="hidden lg:block">
            {/* svg chữ instagram */}
            {isLocationChat ? ( // 2 loại icon khác nhau khi vào route message
              <svg 
          ...
          {navItems.map((item, index) => (
            ...
            >
              ...
              >
                ...
                {selectedNavItem == index ? item.icon[1] : item.icon[0]}{" "}
                {/*  icon nhạt là 0 , icon đậm là 1 */}
                <span
                  className={`hidden lg:block text-lg ${
                    selectedNavItem == index ? "font-bold" : ""
                  }`}
                >
                  {isLocationChat ? "" : item.label}
                </span>
              </Link>
            </li>
          ))}
            ...
            <Dialog>
              <DialogTrigger asChild>
                ...
                >
                  ...
                  <span className="hidden lg:block text-lg">{isLocationChat ? "" : "Tạo"}</span>
                </Button>
              </DialogTrigger>
              <CreatePostModal />
            </Dialog>
